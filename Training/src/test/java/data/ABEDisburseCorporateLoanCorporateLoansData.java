...
public class ABEDisburseCorporateLoanCorporateLoansData {
	...
	private String valueDateStatus;
	...
	public String getValueDateStatus() {
		return valueDateStatus;
	}
	public void setValueDateStatus(String valueDateStatus) {
		this.valueDateStatus = valueDateStatus;
	}
	...
	public String toString() {
		return "ABEDisburseCorporateLoanCorporateLoansData [tcId=" + tcId + ", summary=" + summary + ", username="
				...
				+ valueDate + ", valueDateStatus=" + valueDateStatus + ", disbursmentType=" + disbursmentType
				+ ", disbursmentAccount=" + disbursmentAccount + ", expectedResult=" + expectedResult + ", linkedTcId="
				+ linkedTcId + "]";
	}
}
