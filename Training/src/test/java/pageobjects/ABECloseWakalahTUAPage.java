...
public class ABECloseWakalahTUAPage {
	...
	private By menuNameTextBox = By.xpath("(//h1[normalize-space()='Close Deposit Account'])[1]");
	...
	public ABECloseWakalahTUAPage(WebDriver driver) {
		this.driver = driver;
	}
	
	@Step("Sending menu name: {0}")
	public ABECloseWakalahTUAPage sendKeysSearchBarTextField(String menu) throws Exception {
		if(menu != null) {
	...
	public ABECloseWakalahTUAPage switchFormAreaFrame() throws Exception {
		PageFunctionUtils.sleep();
		PageFunctionUtils.switchToParentFrame(driver);
		PageFunctionUtils.waitOnFrameAndSwitchId(driver, loginFrameIframeId);
	...
	public ABECloseWakalahTUAPage sendKeysAccountIdTextField(String accountId) throws Exception {
		if(accountId != null) {
	...
	public ABECloseWakalahTUAPage sendKeysClosureValueDateTextField(String closureValueDate) throws Exception {
	...
	public ABECloseWakalahTUAPage pressGoButton() throws Exception {
		PageFunctionUtils.clickOnElement(driver, goButton);
		return this;
	}
	
	@Step("Sending repayment account id: {0}")
	public ABECloseWakalahTUAPage sendKeysRepaymentAccountIdTextField(String repaymentAccountId) throws Exception {
	...
	public ABECloseWakalahTUAPage pressSubmitButton() throws Exception {
	...
	public ABECloseWakalahTUAPage saveAccountId(String linkedId) throws Exception {
		int rowByTcid1 = CSVUtils.getRowByTcid(Paths.ABECLOSEWAKALAHTUACSV, linkedTcidCsvColumnName, linkedId);
		int rowByTcid2 = CSVUtils.getRowByTcid(Paths.ABEVERIFYWAKALAHTUACLOSURECSV, tcIdCsvColumnName, linkedId);
		int columnByColumnName2 = CSVUtils.getColumnByColumnName(Paths.ABEVERIFYWAKALAHTUACLOSURECSV, accountIdCsvColumnName);
		if(rowByTcid1 != -1 && rowByTcid2 != -1) {
			CSVUtils.insertValueInCsvCell(Paths.ABEVERIFYWAKALAHTUACLOSURECSV, rowByTcid2, columnByColumnName2, acId);
		}
		return this;
	}	
}