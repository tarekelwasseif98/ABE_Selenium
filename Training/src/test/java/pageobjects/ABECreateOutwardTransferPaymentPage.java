...
//		PageFunctionUtils.clickOnElement(driver,chargeFetchButton);
	...
	public ABECreateOutwardTransferPaymentPage saveACHPO(String paysysId, String linkedId) throws Exception {
		if (paysysId.equals("ACH")) {
			int rowByTcid1 = CSVUtils.getRowByTcid(Paths.ABECREATEACHOUTWARDCSV, linkedTcidCsvColumnName, linkedId);
			int columnByColumnName1 = CSVUtils.getColumnByColumnName(Paths.ABECREATEACHOUTWARDCSV, posCsvColumnName);
			int rowByTcid2 = CSVUtils.getRowByTcid(Paths.ABEVERIFYACHOUTWARDCSV, tcIdCsvColumnName, linkedId);
			int columnByColumnName2 = CSVUtils.getColumnByColumnName(Paths.ABEVERIFYACHOUTWARDCSV, posCsvColumnName);
			int rowByTcid3 = CSVUtils.getRowByTcid(Paths.ABEATHORIZEACHOUTWARDCSV, linkedTcidCsvColumnName, linkedId);
			int columnByColumnName3 = CSVUtils.getColumnByColumnName(Paths.ABEATHORIZEACHOUTWARDCSV, posCsvColumnName);
			if(rowByTcid1 != -1 && rowByTcid2 != -1 && rowByTcid3 != -1) {
				CSVUtils.insertValueInCsvCell(Paths.ABECREATEACHOUTWARDCSV, rowByTcid1, columnByColumnName1, poID);
				CSVUtils.insertValueInCsvCell(Paths.ABEVERIFYACHOUTWARDCSV, rowByTcid2, columnByColumnName2, poID);
				CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZEACHOUTWARDCSV, rowByTcid3, columnByColumnName3, poID);
			}
		}
				...
				int rowByTcid33 = CSVUtils.getRowByTcid(Paths.ABEATHORIZEACHUSOUTWARDCSV, linkedTcidCsvColumnName, linkedId);
				int columnByColumnName33 = CSVUtils.getColumnByColumnName(Paths.ABEATHORIZEACHUSOUTWARDCSV, posCsvColumnName);
				if(rowByTcid11 != -1 && rowByTcid22 != -1 && rowByTcid33 != -1) {
					...
					CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZEACHUSOUTWARDCSV ,rowByTcid33, columnByColumnName33, poID);
				}	
	}
			...
			int rowByTcid333 = CSVUtils.getRowByTcid(Paths.ABEATHORIZEACHEROUTWARDCSV, linkedTcidCsvColumnName, linkedId);
			int columnByColumnName333 = CSVUtils.getColumnByColumnName(Paths.ABEATHORIZEACHEROUTWARDCSV, posCsvColumnName);
			if(rowByTcid111 != -1 && rowByTcid222 != -1 && rowByTcid333 != -1) {
				CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZEACHOUTWARDCSV, rowByTcid111, columnByColumnName111, poID);
				CSVUtils.insertValueInCsvCell(Paths.ABEVERIFYACHEROUTWARDCSV, rowByTcid222, columnByColumnName222, poID);
				CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZEACHEROUTWARDCSV, rowByTcid333, columnByColumnName333, poID);
			}
}
			...
			int rowByTcid3333 = CSVUtils.getRowByTcid(Paths.ABEATHORIZESWIFTOUTWARDCSV, linkedTcidCsvColumnName, linkedId);
			int columnByColumnName3333 = CSVUtils.getColumnByColumnName(Paths.ABEATHORIZESWIFTOUTWARDCSV, posCsvColumnName);
			if(rowByTcid1111 != -1 && rowByTcid2222 != -1 && rowByTcid3333 != -1) {
				...
				CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZESWIFTOUTWARDCSV, rowByTcid3333, columnByColumnName3333, poID);
			}
			}
				...
				int rowByTcid33333 = CSVUtils.getRowByTcid(Paths.ABEATHORIZEESWIFTOUTWARDCSV, linkedTcidCsvColumnName, linkedId);
				int columnByColumnName33333 = CSVUtils.getColumnByColumnName(Paths.ABEATHORIZEESWIFTOUTWARDCSV, posCsvColumnName);
				if(rowByTcid11111 != -1 && rowByTcid22222 != -1 && rowByTcid33333 != -1) {
					...
					CSVUtils.insertValueInCsvCell(Paths.ABEATHORIZEESWIFTOUTWARDCSV, rowByTcid33333, columnByColumnName33333, poID);
				}
				}
