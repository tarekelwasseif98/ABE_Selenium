...
public class ABEOpenWakalahTUAPage {
	...
	private By accountPeggedNoRadioButton = By.xpath("(//input[@id='_acPgdNo_radio'])[1]");
	private By renewalAndClosureDetailsTab = By.xpath("(//a[@id='stepVIII_anchor'])[1]");
	
	private By submitButton = By.xpath("(//button[normalize-space()='Submit'])[1]");
	private By menuNameTextBox = By.xpath("(//h1[normalize-space()='Open Top Up Deposit Account'])[1]");
	...
	public ABEOpenWakalahTUAPage(WebDriver driver) {
		this.driver = driver;
	}
	
	@Step("Sending menu name: {0}")
	public ABEOpenWakalahTUAPage sendKeysSearchBarTextField(String menu) throws Exception {
		if(menu != null) {
	...
	public ABEOpenWakalahTUAPage switchFormAreaFrame() throws Exception {
		PageFunctionUtils.sleep();
		PageFunctionUtils.switchToParentFrame(driver);
		PageFunctionUtils.waitOnFrameAndSwitchId(driver, loginFrameIframeId);
	...
	public ABEOpenWakalahTUAPage sendKeysCifIdTextField(String cifId) throws Exception {
		if(cifId != null) {
	...
	public ABEOpenWakalahTUAPage sendKeysSchemeCodeTextField(String schemeCode) throws Exception {
		if(schemeCode != null) {
	...
	public ABEOpenWakalahTUAPage pressGoButton() throws Exception {
		PageFunctionUtils.clickOnElement(driver, goButton);
		return this;
	}
	
	@Step("Sending value date: {0}")
	public ABEOpenWakalahTUAPage sendKeysValueDateTextField(String valueDate) throws Exception {
		if(valueDate != null) {
	...
	public ABEOpenWakalahTUAPage sendKeysDepositPeriodMonthsTextField(String depositPeriodMonths) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysDepositPeriodDaysTextField(String depositPeriodDays) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysInitialDepositAmountTextField(String initialDepositAmount) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysProfitCreditAccountIdTextField(String profitCreditAccountId) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysRepaymentAccountIdTextField(String repaymentAccountId) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysDebitAccountIdTextField(String debitAccountId) throws Exception {
	...
	public ABEOpenWakalahTUAPage pressContinue1Button() throws Exception {
		PageFunctionUtils.clickOnElement(driver, continue1Button);
		return this;
	}
	
	@Step("Sending account opening date: {0}")
	public ABEOpenWakalahTUAPage sendKeysAccountOpeningDateTextField(String accountOpeningDate) throws Exception {
	...
	public ABEOpenWakalahTUAPage sendKeysApplicationDateTextField(String applicationDate) throws Exception {
	...
	@Step("Press continue button")
	public ABEOpenWakalahTUAPage pressContinue2Button() throws Exception {
		PageFunctionUtils.clickOnElement(driver, continue2Button);
		return this;
	}
	
	@Step("Press continue button")
	public ABEOpenWakalahTUAPage pressContinue3Button() throws Exception {
		PageFunctionUtils.clickOnElement(driver, continue3Button);
		return this;
	}
	
	@Step("Press account pegged no radio button")
	public ABEOpenWakalahTUAPage pressAccountPeggedNoButton() throws Exception {
		PageFunctionUtils.clickOnElement(driver, accountPeggedNoRadioButton);
		return this;
	}
	
	@Step("Renewal and closure details tab navigation")
	public ABEOpenWakalahTUAPage navigateRenewalAndClosureDetailsTabMenu() throws Exception {
	...
	public ABEOpenWakalahTUAPage pressSubmitButton() throws Exception {
	...
	public ABEOpenWakalahTUAPage saveAccountId(String linkedId, String closeLinkedTcid) throws Exception {
		int rowByTcid1 = CSVUtils.getRowByTcid(Paths.ABEOPENWAKALAHTUACSV, linkedTcidCsvColumnName, linkedId);
		int columnByColumnName1 = CSVUtils.getColumnByColumnName(Paths.ABEOPENWAKALAHTUACSV, referenceCsvColumnName);
		int rowByTcid2 = CSVUtils.getRowByTcid(Paths.ABEVERIFYWAKALAHTUAOPENINGCSV, tcIdCsvColumnName, linkedId);
		int columnByColumnName2 = CSVUtils.getColumnByColumnName(Paths.ABEVERIFYWAKALAHTUAOPENINGCSV, accountIdCsvColumnName);
		if(rowByTcid1 != -1 && rowByTcid2 != -1) {
			CSVUtils.insertValueInCsvCell(Paths.ABEOPENWAKALAHTUACSV, rowByTcid1, columnByColumnName1, accountId);
			CSVUtils.insertValueInCsvCell(Paths.ABEVERIFYWAKALAHTUAOPENINGCSV, rowByTcid2, columnByColumnName2, accountId);
		}
		int rowByTcid3 = CSVUtils.getRowByTcid(Paths.ABEOPENWAKALAHTUACSV, closeLinkedTcidCsvColumnName, closeLinkedTcid);
		int rowByTcid4 = CSVUtils.getRowByTcid(Paths.ABECLOSEWAKALAHTUACSV, tcIdCsvColumnName, closeLinkedTcid);
		int columnByColumnName4 = CSVUtils.getColumnByColumnName(Paths.ABECLOSEWAKALAHTUACSV, accountIdCsvColumnName);
		if(rowByTcid3 != -1 && rowByTcid4 != -1) {
			CSVUtils.insertValueInCsvCell(Paths.ABECLOSEWAKALAHTUACSV, rowByTcid4, columnByColumnName4, accountId);
		}
		return this;
	}							
}