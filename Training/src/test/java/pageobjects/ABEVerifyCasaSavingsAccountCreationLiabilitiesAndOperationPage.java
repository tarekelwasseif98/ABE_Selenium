...
public class ABEVerifyCasaSavingsAccountCreationLiabilitiesAndOperationPage {
	...
	public ABEVerifyCasaSavingsAccountCreationLiabilitiesAndOperationPage pressGoButton() throws Exception {
		driver.findElement(goButton).click();
		return this;
	}
	@Step("Press continue button")
	public ABEVerifyCasaSavingsAccountCreationLiabilitiesAndOperationPage pressContinueButton() throws Exception {
