...
public class ABE_VerifyCasaAccountClosure_Mudarabah_Page {
	...
	public ABE_VerifyCasaAccountClosure_Mudarabah_Page sendKeysSearchBarTextField(String menu) throws Exception {
	...
	public ABE_VerifyCasaAccountClosure_Mudarabah_Page switchFormAreaFrame() throws Exception {
		PageFunctionUtils.sleep();
		driver.switchTo().parentFrame();
	    driver.switchTo().frame((loginFrameIframeId));
	...
	public ABE_VerifyCasaAccountClosure_Mudarabah_Page sendKeysAccountIdTextField(String accountId) throws Exception {
