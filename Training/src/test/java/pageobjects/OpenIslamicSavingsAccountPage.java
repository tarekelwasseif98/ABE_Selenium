...
public class OpenIslamicSavingsAccountPage {
	...
	public OpenIslamicSavingsAccountPage pressSubmit() throws Exception {
		...
		CSVReader reader = new CSVReader(new FileReader(csvPaths.VISAO_CSV));
		List<String[]> lines = reader.readAll();
		reader.close();
		String[] newRow = new String[lines.get(0).length];
			newRow[columnIndex] = "'" + acid;
			newRow[0] = "FCB-9727";
			newRow[2] = "ABE30";
			newRow[3] = "Infy@123";
			newRow[4] = "VISAO";
			lines.add(newRow);
			CSVWriter writer = new CSVWriter(new FileWriter(csvPaths.VISAO_CSV));
