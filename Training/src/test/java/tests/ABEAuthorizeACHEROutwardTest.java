...
@Test(groups = "AuthorizeACHER",dependsOnGroups = "VerifyACHER")
@Listeners({AllureTestNg.class})
public class ABEAuthorizeACHEROutwardTest {
	...
	@DataProvider(name="Authorize ACHER Outward DataProvider")
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEAuthorizeACHEROutwardCsv);
		workbook.save(Paths.ABEAuthorizeACHEROutwardJson);
        ...
        List<ABEAuthorizeOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEAuthorizeACHEROutwardJson);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Authorize ACHER Outward DataProvider", dataProviderClass = ABEAuthorizeACHEROutwardTest.class)
