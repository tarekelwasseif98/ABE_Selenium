...
public class ABEAuthorizeESWIFTOutwardTest {
	...
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEATHORIZEESWIFTOUTWARDCSV);
		workbook.save(Paths.ABEATHORIZEESWIFTOUTWARDJSON);
        ...
        List<ABEAuthorizeOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEATHORIZEESWIFTOUTWARDJSON);
        dataList.toArray();
