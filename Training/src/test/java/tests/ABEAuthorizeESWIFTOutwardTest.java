...
@Test(groups = "AuthorizeESWIFT",dependsOnGroups = "VerifyESWIFT")
@Listeners({AllureTestNg.class})
public class ABEAuthorizeESWIFTOutwardTest {
	...
	@DataProvider(name="Authorize SWIFT Outward DataProvider")
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEAuthorizeESWIFTOutwardCsv);
		workbook.save(Paths.ABEAuthorizeESWIFTOutwardJson);
        ...
        List<ABEAuthorizeOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEAuthorizeESWIFTOutwardJson);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Authorize ESWIFT Outward DataProvider", dataProviderClass = ABEAuthorizeESWIFTOutwardTest.class)
