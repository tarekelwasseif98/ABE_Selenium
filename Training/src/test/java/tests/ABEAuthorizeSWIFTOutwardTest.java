...
public class ABEAuthorizeSWIFTOutwardTest {
	...
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEATHORIZESWIFTOUTWARDCSV);
		workbook.save(Paths.ABEATHORIZESWIFTOUTWARDJSON);
        ...
        List<ABEAuthorizeOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEATHORIZESWIFTOUTWARDJSON);
        dataList.toArray();
