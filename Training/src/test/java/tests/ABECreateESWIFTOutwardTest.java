...
@Test( groups = "CreateESWIFT")
@Listeners({AllureTestNg.class})

public class ABECreateESWIFTOutwardTest {

	@BeforeClass
	public void oneTimeSetUp() throws IOException, CsvException {
		CSVUtils.clearColumnByName(Paths.ABECREATEESWIFTOUTWARDCSV, "Pos");
	}
	...
	public void beforeTest(Object [] testData) throws Exception {
		...
		testCaseId = CSVUtils.getTestCaseId(Paths.ABECREATEESWIFTOUTWARDCSV);
	...
	@DataProvider(name="Create ESWIFT Outwrad DataProvider")
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABECREATEESWIFTOUTWARDCSV);
		workbook.save(Paths.ABECREATEESWIFTOUTWARDJSON);
        ...
        List<ABECreateOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABECREATEESWIFTOUTWARDJSON);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Create ESWIFT Outwrad DataProvider", dataProviderClass = ABECreateESWIFTOutwardTest.class)
	@Step("{testCaseId}")
