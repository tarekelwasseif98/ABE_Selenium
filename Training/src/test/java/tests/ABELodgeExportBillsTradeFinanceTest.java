...
public class ABELodgeExportBillsTradeFinanceTest {
	...
	public Object[] dpMethod() throws Exception {
        ...
        List<ABELodgeExportBillsTradeFinanceData> dataList = jsonReader.readJsonFile(Paths.OpenCorporateLoanJson);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Open Corporate Loan Corporate Loans DataProvider", dataProviderClass = ABELodgeExportBillsTradeFinanceTest.class)
	public void openCorporateLoanCorporateLoansTest(ABELodgeExportBillsTradeFinanceData data) throws Exception {
