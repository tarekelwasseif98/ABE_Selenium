...
public class ABEVerifyESWIFTOutwardTest {
	...
	@DataProvider(name="Verify ESWIFT Outward DataProvider")
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEVERIFYESWIFTOUTWARDCSV);
		workbook.save(Paths.ABEVERIFYESWIFTOUTWARDJSON);
        ...
        List<ABEVerifyOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEVERIFYESWIFTOUTWARDJSON);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Verify ESWIFT Outward DataProvider", dataProviderClass = ABEVerifyESWIFTOutwardTest.class)
