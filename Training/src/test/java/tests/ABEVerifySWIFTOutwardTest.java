...
public class ABEVerifySWIFTOutwardTest {
	...
	@DataProvider(name="Verify SWIFT Outward DataProvider")
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEVerifySWIFTOutwardCsv);
		workbook.save(Paths.ABEVerifySWIFTOutwardJson);
        ...
        List<ABEVerifyOutwardTransferPaymentData> dataList = jsonReader.readJsonFile(Paths.ABEVerifySWIFTOutwardJson);
        dataList.toArray();
        return dataList.toArray();
	}
	
	@Test(dataProvider = "Verify SWIFT Outward DataProvider", dataProviderClass = ABEVerifySWIFTOutwardTest.class)
