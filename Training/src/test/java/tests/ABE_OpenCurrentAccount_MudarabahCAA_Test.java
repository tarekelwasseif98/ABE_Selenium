...
@Test(groups = "ABE_OpenCurrentAccount_MudarabahCAA_Test")
@Listeners({AllureTestNg.class})
public class ABE_OpenCurrentAccount_MudarabahCAA_Test {
	...
	@Test(dataProvider = "Open Current Account Mudarabah CAA DataProvider", dataProviderClass = ABE_OpenCurrentAccount_MudarabahCAA_Test.class)
	public void openIslamicCurrentAccount(ABEOpenCurrentAccountMudarabahCAAData data) throws Exception {
		Allure.getLifecycle().updateTestCase(tc -> tc.setName("Test Case ID: " + data.getTCID()));
		Allure.parameter("Data: ", data.toString());		
        ABE_OpenCurrentAccount_MudarabahCAA_Procedures.openCurrentAccountMudarabahCAA(driver, data);
