...
public class ABE_OpenIslamicCurrentAccount_MudarabahCAA_Test {
	...
	/*
	 * @BeforeClass public void oneTimeSetUp() throws IOException, CsvException {
	 * CSVUtils.clearColumnByName(Paths.OpenIslamicCurrentAccountCsv, "reference");
	 * CSVUtils.clearColumnByName(Paths.VerifyIslamicCurrentAccountCsv,
	 * "accountId"); }
	 */
	 ...
	 * @Test(dataProvider = "Open Islamic Current Account DataProvider",
	 * dataProviderClass = ABE_OpenIslamicCurrentAccount_MudarabahCAA_Test.class)
	 * 
	 * @Step("{testCaseId}") <<<<<<<
	 * HEAD:Training/src/test/java/tests/ABE_OpenIslamicSavingsAccount_MudarabahSBA.
	 * java public void openIslamicSavingsAccount(OpenIslamicSavingsAccountData
	 * data) throws Exception { //Allure.getLifecycle().updateTestCase(tc ->
	 * tc.setName("Test Case ID: " + testCaseId)); ======= public void
	 * openIslamicCurrentAccount(OpenIslamicCurrentAccountData data) throws
	 * Exception { Allure.getLifecycle().updateTestCase(tc ->
	 * tc.setName("Test Case ID: " + data.getTCID())); >>>>>>>
	 * f326dc4bab08ab0450dc67107b6d076bdf5d2e19:Training/src/test/java/tests/
	 * ABE_OpenIslamicCurrentAccount_MudarabahCAA_Test.java
	 * Allure.parameter("Data: ", data.toString());
	 * OpenIslamicCurrentAccountProcedures.islamicCurrentAccountByMaker(driver,
