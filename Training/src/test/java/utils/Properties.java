...
public class Properties {
	...
	public static final String openIslamicSavingsAccountJson = "jsonFiles\\OpenIslamicSavingsAccount.json";
	public static final String verifyIslamicSavingsAccountJson = "jsonFiles\\VerifyIslamicSavingsAccount.json";
